...
export const ru_RU: typeof zh_CH = {
  ...
  PATH_INVALID_FORBIDDEN_DIR: 'Пожалуйста, выберите путь, который не находится внутри "Рабочий стол", "Загрузки" или "Документы".',
  NOT_SUPPORTED_YET: "Функция еще не поддерживается",
  PLEASE_WAIT_FOR_LAUNCHER_UPDATE: "В настоящее время лаунчер не поддерживает версию {0}, дождитесь обновлений",
  UNSUPPORTED_VERSION: "Не поддерживаемая версия",
  SELECT_INSTALLATION_DIR: "Пожалуйста, выберите каталог установки игры.\nЕсли вы уже установили игру, выберите, где находится исполняемый файл игры.",
  CANT_OPEN_GAME_FILE: "Не удалось получить доступ к файлу игры",
  CANT_OPEN_GAME_FILE_DESC: "Лаунчеру не удалось получить доступ к файлу игры.\nНо не волнуйтесь, вы можете снова выбрать каталог установки игры, когда это диалоговое окно закроется\n\nЕсли это диалоговое окно появляется повторно, пожалуйста, проверьте, имеет ли программа запуска правильные разрешения для доступа к каталогу установки игры",
  GAME_DIR_CHANGED: "Путь к каталогу изменен",
  GAME_DIR_CHANGED_DESC: "Похоже, вы выбрали другой путь, который отличается от ранее выбранного. Эта операция недопустима, но вы можете выбрать ее позже",

  NEW_VERSION_AVALIABLE: "Доступна новая версия",
  NEW_VERSION_AVALIABLE_DESC: "Хотите ли вы обновить лаунчер до версии {0}?\n Что обновлено:\n{1}",
  ...
  RELAUNCH_REQUIRED_DESC: "Программа запуска перезагрузится, чтобы выполнить установку wine.",
  ...
  SETTING_WINE_CROSSOVER_ALERT: "Чтобы использовать crossover, существует дополнительный шаг, который необходимо выполнить вручную. Нажмите на это поле, чтобы ознакомиться с подробностями.",

  SETTING_FPS_UNLOCK: "Разблокируйте FPS лимит",
  SETTING_FPS_UNLOCK_DEFAULT: "Выключено",

  SETTING_ADVANCED: "Дополнительные",
  SETTING_ADVANCED_ALERT: "НИЧЕГО НЕ МЕНЯЙТЕ, если только вы не знаете, что делаете.",
