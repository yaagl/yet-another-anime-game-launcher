...
export const vi_VN: typeof zh_CN = {
  ...
  SELECT_INSTALLATION_DIR:
    "Vui lòng chọn thư mục cài đặt trò chơi.\nNếu như bạn đã có sẵn game thì hãy chọn thư mục có chứa tệp .exe của game.",
  ...
  GAME_DIR_CHANGED_DESC:
    "Dường như như bạn đã chọn một thư mục khác với thư mục đã được chọn trước đó. Tiến trình không hợp lệ, nhưng bạn có thể điều chỉnh lại sau",
  ...
  DOWNLOADING_UPDATE_FILE: "Đang tải cập nhật",

  UPGRADE_FUNCTION_TBD: "Hiện tại việc nâng cấp vẫn chưa được tích hợp.",
  ...
  RELAUNCH_REQUIRED: "Yêu cầu khởi động lại trình khởi động",
  ...
  SETTING_ASYNC_DXVK: "Biên dịch shader DXVK Async",
  SETTING_ENABLED: "Bật",
  ...
  SETTING_LEFT_CMD: "Đặt phím CMD trái thành CTRL",
  ...
  SETTING_OPEN_CMD: "Mở công cụ Command Line (CMD) của Wine",
  ...
  SETTING_ADVANCED_ALERT:
    "TUYỆT ĐỐI KHÔNG THAY ĐỔI BẤT KỲ THỨ GÌ, trừ khi bạn biết mình đang làm gì.",
