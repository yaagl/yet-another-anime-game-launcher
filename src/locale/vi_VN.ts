...
export const vi_VN: typeof zh_CN = {
  ...
  SCANNING_FILES: "Kiểm tra tính toàn vẹn của tệp. {0}/{1} tệp đã được hoàn thành ",
  ...
  PATH_INVALID_FORBIDDEN_DIR: 'Vui lòng hãy chọn đường dẫn khác ngoài "Desktop","Downloads" hoặc "Documents"',
  NOT_SUPPORTED_YET: "Chức năng chưa được hỗ trợ",
  PLEASE_WAIT_FOR_LAUNCHER_UPDATE: "Trình khởi động hiện tại vẫn chưa hỗ trợ phiên bản {0}, xin vui lòng hãy đợi bản cập nhật mới",
  UNSUPPORTED_VERSION: "Phiên bản không được hỗ trợ",
  SELECT_INSTALLATION_DIR: "Vui lòng chọn thư mục cài đặt trò chơi.\nNếu như bạn đã có sẵn game thì hãy chọn thư mục có chứa tệp thực thi (.exe) của game",
  CANT_OPEN_GAME_FILE: "Không truy cập được tệp của trò chơi",
  CANT_OPEN_GAME_FILE_DESC: "Trình khởi động không truy cập được tệp trò chơi\nNhưng đừng lo, bạn có thể chọn lại thư mục cài đặt trò chơi khi bảng này được đóng\n\nNếu như bảng này vẫn lặp lại liên tục, hãy kiểm tra liệu trình khởi động có được cấp quyền để truy cập thư mục cài đặt trò chơi này không",
  GAME_DIR_CHANGED: "Đường dẫn thư mục đã được thay đổi",
  GAME_DIR_CHANGED_DESC: "Dường như như bạn đã chọn một thư mục khác với thư mục đã được chọn trước đó. Tiến trình không hợp lệ, nhưng bạn có thể chọn lại sau",

  NEW_VERSION_AVALIABLE: "Phiên bản mới khả dụng",
  NEW_VERSION_AVALIABLE_DESC: "Bạn có muốn cập nhật trình khởi động lên phiên bản {0} không?\n Những thứ được cập nhật:\n{1}",
  ...
  RELAUNCH_REQUIRED_DESC: "Trình khởi động sẽ khởi động lại để tiến hành quá trình cài đặt wine.",
